...
/*
  $bgrs_dir = TEMPLATEPATH.'/images/bgrs/'; 
  $bgrs_files = ReadFolderDirectory($bgrs_dir);

  //Add the none_bgr
  $bgrs_files[] = array('label' => "None",'src' => get_bloginfo ( 'template_url' )."/images/none_bgr.png" ,'value' => get_bloginfo ( 'template_url' )."/images/none_bgr.png"); 
                        		
 //	print_r($bgrs_files); 	
  // Add the styling for the image-radios:
  echo "<style>
  			.admin_bgr_images {	width: 80px; height: 80px; }
  		</style>"; 
*/  
  ...
  $custom_settings = array(
	...
	array(
	  ...
	  'id'          => 'logo_top_margin',
	  'type'        => 'measurement',
	  'desc'        => 'Change Default top margin for logo image. <br><em>Leave blank for Default. Default value is 66px.</em>',
	  'std'         => '',
	  'rows'        => '',
	  'post_type'   => '',
	  'taxonomy'    => '',
	  ...
	  'id'          => 'logo_left_margin',
	  'type'        => 'measurement',
	  'desc'        => 'Change Default left margin for logo image. <br><em>Leave blank for Default. Default value is 20px.</em>',
	  'std'         => '',
	  'rows'        => '',
	  'post_type'   => '',
	  'taxonomy'    => '',
...
array(
  ...
  'id'          => 'main_color',
  'desc'        => 'Select your Main HighLight Color to be used throughout the whole theme. (Default is: "#0ad1e5")',
  'std'         => '#0ad1e5',
  'type'        => 'colorpicker',
...
array(
  ...
  'id'          => 'navigation_style',
  'desc'        => 'Select your Main Navigation Style',
...
array(
  'label'       => 'Main Navigation Background Color (only applies to Custom Style Menu)',
  'id'          => 'nav_bgr_color',
  'desc'        => 'Select your Main Navigation Background Color. It only applies to the Custom Style Menu from the previous option selection. (Default is: "#0ad1e5")',
  'std'         => '#0ad1e5',
  'type'        => 'colorpicker',
  'section'     => 'theme_styles',
  ),  
...
array(
  ...
  'desc'        => 'Choose Font Family for headers (h1-h6). (Default is Open Sans)',
  'std'         => 'Open+Sans',
  'type'        => 'select',
  'section'     => 'typography',
  'rows'        => '',
...
array(
  ...
  'desc'        => 'Choose Font Family for your Buttins and Button Links. (Default is Open Sans)',
  'std'         => 'Open+Sans',
  'type'        => 'select',
  'section'     => 'typography',
  'rows'        => '',
...
array(
  ...
  'id'          => 'body_bgr',
  'type'        => 'radio-image',
  'desc'        => 'Choose a Body Background Image. You can enable the Front End Styler Popup from below to get a better idea of how each would look. If you don\'t want a Background Pattern select None, and choose a Background Color from below.',
  'std'         => '0.png',
  'rows'        => '',
  'post_type'   => '',
  'taxonomy'    => '',
  'class'       => 'admin_bgr_images',
  'section'     => 'theme_styles',
  'choices'		=> $bgrs_files,
  ),   
...
array(
  ...
  'id'          => 'body_bgr_color',
  'desc'        => 'To have this color as your Body Background select None from the option above. <br>(Default is: "#f6f6f6")',
  'std'         => '#f6f6f6',
  'type'        => 'colorpicker',
  'section'     => 'theme_styles',
  ),   
...
array(
  ...
  'std'         => '<a href="http://themeforest.net/user/blueowlcreative/portfolio?ref=blueowlcreative" target="_blank">AquaCart Theme</a> &copy; 2012 &nbsp; | &nbsp; <a href="http://www.blueowlcreative.com" target="_blank">BlueOwlCreative</a>',
  'rows'        => '',
  'post_type'   => '',
  'taxonomy'    => '',
  'class'       => '',
...
array(
  ...
  'settings'    => array(
    array(
      ...
      'id'          => 'id',
      'type'        => 'text',
      'desc'        => 'Write a lowercase single world as ID (or number), no spaces',
      'std'         => '',
      'rows'        => '',
      'post_type'   => '',
      'taxonomy'    => '',
...
array(
  ...
  'section'     => 'general'
	  ...
	  'type'        => 'text',
	  'desc'        => 'Enter how many items per Page you want in your Portfolio Page (Integer)',
	  'std'         => '9',
	  'rows'        => '',
	  'post_type'   => '',
	  'taxonomy'    => '',
