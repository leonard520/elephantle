                                    ...
                                    <?php while ($the_query->have_posts() ) : $the_query->the_post(); ?>
                                        ...
                                        <li class="slide">	
											...
											if ( has_post_thumbnail()) { 
													...
													$wiltoimagealt = PhotoSmyth_get_limited_string(get_the_title(), 40, '...');											
													echo '<div class="wrimg"><img alt="'.$wiltoimagealt.'" src="'.$wiltoimage[0].'" /></div>';													
                                            }else {
													$wiltoimage = get_stylesheet_directory_uri().'/images/PhotoSmythfeaturedthumb.png';
													$wiltoimagealt = PhotoSmyth_get_limited_string(get_the_title(), 40, '...');											
                                            ...
                                            <div class="wrtext">
                                            	<div class="wrsubtexth2">
                                                    <h2>
                                                        <a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'PhotoSmyth' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php echo PhotoSmyth_get_limited_string(get_the_title(), 40, '...') ?></a>
                                                    </h2>
                                                </div>
                                                
                                                <div class="wrsubtext">
                                                    <p>
                                                        <?php echo PhotoSmyth_get_limited_string(get_the_excerpt(), 150, '...') ?>
                                                    </p>
                                                </div>
                                                
                                                <div class="wrsubtextmore">
                                                    <p>
                                                        <a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'PhotoSmyth' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php _e('Read More','PhotoSmyth'); ?></a>
                                                    </p> 
                                                </div>                                           
                                            </div>
                                        </li>
