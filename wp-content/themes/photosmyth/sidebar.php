                        ...
                        <div id="sidebar_section">
                            ...
                            <div id="feed_social">
                                            ...
                                            <div id="sidebar_facebook">
                                            	...
                                            	<p><a href="<?php echo esc_url( of_get_option('facebook_id') ); ?>"><?php _e('Be A Fan On Facebook', 'PhotoSmyth') ?></a></p>
                                            ...
                                            <div id="sidebar_twitter">
                                            	...
                                            	<p><a href="http://www.twitter.com/<?php echo esc_attr( of_get_option('twitter_id') ); ?>"><?php _e('Follow On Twitter',  'PhotoSmyth') ?></a></p>                                            
										...
										<?php if ( function_exists('dynamic_sidebar') && dynamic_sidebar('Default') ){
																		...
																		<div class="sidebar_widget">
																			...
																			<div class="widget widget_categories">
																				<h3 class="widgettitle"><?php _e('Categories', 'PhotoSmyth') ?></h3>
																				<ul>
