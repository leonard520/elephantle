...
?>
    ...
    <div class="new_options_container">
    	...
    	<div id="countrytabs" class="new_options_container_middle">
			...
			<ul class="shadetabs">
            	<li class="big"><a href="#country1"><h6><?php echo __('General', 'PhotoSmyth'); ?></h6><p><?php echo __('Settings', 'PhotoSmyth'); ?></p></a></li>
                <li class="small"><a href="#country2"><p><?php echo __('Social Settings', 'PhotoSmyth'); ?></p></a></li>
                <li class="big"><a href="#country3"><h6><?php echo __('Slider', 'PhotoSmyth'); ?></h6><p><?php echo __('Settings', 'PhotoSmyth'); ?></p></a></li>
                <li class="big"><a href="#country4"><h6><?php echo __('Layout', 'PhotoSmyth'); ?></h6><p><?php echo __('Settings', 'PhotoSmyth'); ?></p></a></li>
                <li class="small"><a href="#country7"><p><?php echo __('Mag Settings', 'PhotoSmyth'); ?></p></a></li>
                <li class="small"><a href="#country9"><p><?php echo __('Standard Blog Settings', 'PhotoSmyth'); ?></p></a></li>
                <li class="big"><a href="#country5"><h6><?php echo __('Sidebar', 'PhotoSmyth'); ?></h6><p><?php echo __('Settings', 'PhotoSmyth'); ?></p></a></li>       
            </ul>        
    	...
    	<div class="new_options_container_bottom">
            ...
            <input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restore Defaults' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!', 'PhotoSmyth' ) ); ?>' );" />
        </div> 
        </form>        
        </div>
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
		'parent' => 'appearance',
		'id' => 'of_theme_options',
		'title' => __( 'Theme Options', 'PhotoSmyth' ),
